  ...
  return (
    <header
      ...
      style={{
        ...
        borderBottom: "1px solid rgba(95,232,255,0.18)",
      }}
    >
      <button
        onClick={onMenu}
        ...
        aria-label="Menu"
      >
        <Menu className="w-5 h-5 text-cyan-400" strokeWidth={2} />
      </button>
      ...
      <div className="flex items-center gap-2.5">
        ...
        <div className="text-center leading-none">
          <h1 className="font-heading font-black tracking-wider text-[15px] text-white">
            FLOUBA <span style={{ color: "#5fe8ff" }}>ELITE</span>
          </h1>
          <p className="text-[9px] uppercase tracking-[0.28em] text-cyan-400/70 mt-0.5 font-heading">
      ...
      >
        <Bell className="w-5 h-5 text-cyan-400" strokeWidth={2} />
        {unread > 0 && (
          <span className="absolute -top-0.5 -right-0.5 min-w-[16px] h-4 px-1 rounded-full flex items-center justify-center text-[9px] font-heading font-bold text-[#081020]"

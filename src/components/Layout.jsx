          ...
          {NAV.map((item) => {
            ...
            return (
              ...
              >
                ...
                <span className={cn("text-[9px] sm:text-xs lg:text-sm uppercase tracking-tight sm:tracking-wider font-heading font-bold leading-none whitespace-nowrap text-center", active && "text-[#FF3131]")}>
                  {item.label}
                </span>
              </button>
            );
